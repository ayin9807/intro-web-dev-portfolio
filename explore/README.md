...
- Estimated Number of Hours Worked: 8
- Students with whom I discussed the assignment: None
- Resources used:
	- React's documentation on their website (https://reactjs.org/docs/hello-world.html)
    - Passing data between components in React (https://medium.com/@ruthmpardee/passing-data-between-react-components-103ad82ebd17)
    - How to import json files in React (https://stackoverflow.com/questions/29452822/how-to-fetch-data-from-local-json-file-on-react-native/37781882#37781882)
    - Using input/forms in React (https://medium.com/capital-one-developers/how-to-work-with-forms-inputs-and-events-in-react-c337171b923b)
- Assets: 
    - Dictionary json file from https://github.com/adambom/dictionary
- Bugs/concerns: 
- Other comments:
    - I decided to make a simple and slightly stupid app called WordUp. Basic functionalities are searching up words in a dictionary and upvoting words. There's a list of the top 5 most upvoted words. I decided to make this for two reasons:
    1) Wanted to explore React, learn a new framework for making typical web applications, and compare with Vue
    2) Because my final project also involves upvoting/downvoting things (specifically dishes/eateries), I thought this app could make a good foundation for our final project
